...
<div id="particles-js"></div>
	<div class="container">
		...
		<form id="" name="" action="" method="post">
			...
			<input type="text" id="apellido" name="apellido" placeholder="ejemplo@gmail.com">
			<br><br>
			<label for="contraseña">Contraseña:</label>
			<input type="password" id="contraseña" name="contraseña" placeholder="Admin123">
			<br><br>
			<a href="normativa.php" target="_blank">Normativa:</a>
			<input type="checkbox" id="myCheckbox" name="normativa">
