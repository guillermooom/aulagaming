...
<?php
	...
	<h4>Turno</h4>
	<form name="formula" metohd="post">
		<input type="submit" name="submit" value="dia">
		<input type="submit" name="submit" value="Tarde">
	</form>	
...
?>
	...
	<?php
		...
		if(!empty($_POST)){
			...
			setcookie("turno", $_POST["turno"], time() + 3600); // Expira en 1 hora
